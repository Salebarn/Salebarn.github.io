...
The following are not goals; they are requirements.  If we cannot meet these requirements, we should not pollute the world with our careless, reckless, ill-conceived app.
